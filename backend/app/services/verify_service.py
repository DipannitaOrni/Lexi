...
chunk (never the whole document at once) — this keeps each LLM call small
and reliable.
"""
import asyncio
...
from app.prompts.verify_prompts import build_verify_user_prompt
...
async def verify_document(
    ...
    `cache_key` should match the rewrite cache key (mode:reading_level) so
    verification results track the exact rewrite they audited.
    """
